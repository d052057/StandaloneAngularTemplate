...
- Create Angular project with ng: `ng new standaloneangulartemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`standaloneangulartemplate.client.esproj`).
